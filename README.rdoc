...
Adva makes it very flexible and extensible: you can only pick 
those engines/features that you really need for your application and 
omit the rest. As they are still all designed to work together seamlessly
and reuse each others functionality the whole platform feels much more
consistent to a collection of similar but separate Rails applications.
...
To run adva specs and stories use:
