...
# #    @calendar.days_in_month_with_events(Date.civil(2009,2,1)).should ==[Date.civil(2009,2,1), Date.civil(2009,2,2), Date.civil(2009,2,1), Date.civil(2009,2,8)].flatten.compact.sort
...
#     @calendar.events.second.update_attribute(:published_at, Time.now)
#     @calendar.instance_variable_set(:@days_in_month_with_events, {})
# #    @calendar.days_in_month_with_events(Date.civil(2009,2,1)).should == [Date.civil(2009, 2, 3)]
#   end
# end