...
#   end
#
#   # FIXME maybe add a short test for your expectations about the stubbed times
#   # and dates? like Time.now.hour.should == 15 as well as something like
#   # mock(CalendarEvent).find(:conditions => ... contains this time ...) when
#   # looking up calendar event scopes? So that you could make sure any problems
#   # would not result from the test setup itself.
#
