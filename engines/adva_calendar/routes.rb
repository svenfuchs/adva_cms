with_options :conditions => { :method => :get } do |m|

  m.calendar_events             "calendars/:section_id/events/:year/:month/:day",
                                :controller => 'events',
                                :action => 'index',
  ...
  m.connect                     "calendars/:section_id/events/:year/:month.:format",
                                :controller => 'events',
                                :action => 'index',
                                :requirements => { :year => /\d{4}/, :month => /\d{1,2}/ }
