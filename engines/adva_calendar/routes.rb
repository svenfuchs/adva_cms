...
map.calendar_event "calendars/:section_id/:id", :controller => 'events', :action => 'show', :requirements => { :method => :get }
map.formatted_calendar_event "calendars/:section_id/:id.:format", :controller => 'events', :action => 'show', :requirements => { :method => :get }
