...
describe TopicsController do
  ...
  describe "POST to :create" do
    ...
    describe "given invalid topic params" do
      before :each do
        @topic.should_receive(:new_record?).and_return true
      end
...
describe "TopicsSweeper" do
  ...
  it "should expire topics that reference a topic, topic's section and section.topics_counter" do
    ...
    @sweeper.should_receive(:expire_cached_pages_by_reference).with(@topic)
    @sweeper.after_save(@topic)
  end
  
  it "should expire pages that reference topic, topic board, board.topics_counter and section.topics_counter " do
