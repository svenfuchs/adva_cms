...
class TicketsIntegrationTest < ActionController::IntegrationTest
  ...
  def view_empty_tickets
    visit "/admin/sites/#{@site.id}/sections/#{@section.id}/projects/#{@project.id}"
    
    renders_template "admin/projects/show"
    response.body.should have_tag("div.empty>a", "Create a new ticket")
  end
  ...
  def create_new_ticket_with_failure
    ...
    renders_template "admin/tickets/new"
