scenario :board_with_three_comments do
  ...
  # , :last_author_email => 'email@email.org'
  topic_attributes = {:title => 'topic title', :body => 'first comment', :last_author => stub_user, :last_author_name => 'name', :board => @board, :section => @forum, :site => stub_site}
