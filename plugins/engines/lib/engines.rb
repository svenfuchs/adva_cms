...
# [+schema_migrations_table+] The table to use when storing plugin migration
#                             version information. Defaults to +plugin_schema_migrations+.
#
...
module Engines
  ...
  mattr_accessor :schema_migrations_table
  self.schema_migrations_table = "plugin_schema_migrations"
