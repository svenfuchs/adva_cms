...
class BlogArticleTest < ActionController::IntegrationTest
  ...
  # FIXME: yields a 404 instead of a redirect
  # TODO: Maybe change this as it isn't really ideal from a SEO perspective ... Should really be a 404!
  def test_view_blog_article_page_for_an_unpublished_article
    ...
    # check that request is redirected to /login
